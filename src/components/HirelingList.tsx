    ...
    return (
      <div className="border border-theme-primary-800 rounded p-4 bg-theme-surface bg-opacity-50">
        ...
        <div className="flex items-end space-x-3 mb-3">
          <div>
            <label className="text-sm font-semibold text-theme-primary-800 block mb-1">FOR</label>
            <input
              type="number"
          ...
          <div>
            <label className="text-sm font-semibold text-theme-primary-800 block mb-1">DES</label>
            <input
              type="number"
          ...
          <div>
            <label className="text-sm font-semibold text-theme-primary-800 block mb-1">VON</label>
            <input
              type="number"
              value={hireling.will}
          ...
          <div>
            <label className="text-sm font-semibold text-theme-primary-800 block mb-1">Custo</label>
            <div className="flex items-center">
              <input
                ...
                min="0"
              />
              <span className="text-theme-primary-800 text-sm ml-1">Grãos</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div>
            <label className="text-sm font-semibold text-theme-primary-800 block">PV</label>
          ...
          <div className="flex-1">
            <label className="text-sm font-semibold text-theme-primary-800 block">Equipamento</label>
            <input
              type="text"
    ...
    <div className="card">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-medium text-theme-primary-800">
          Ajudantes ({character.hirelings.length}/2)
        </h2>
      ...
      {character.hirelings.length === 0 ? (
        <div className="text-center text-theme-primary-800 opacity-75 py-8">
          Sem Ajudantes anida. Clique em "Adicionar Ajudante" para adicionar um.
        </div>
      ) : (
