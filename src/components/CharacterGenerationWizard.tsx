...
export const CharacterGenerationWizard: React.FC<CharacterGenerationWizardProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-theme-surface rounded-lg shadow-lg w-full max-w-2xl mx-4 max-h-[90vh] relative">
        <div className="p-6">
          ...
          <div className="mb-20 max-h-[50vh] overflow-y-auto">
            {renderStep()}
          </div>
        </div>

        <div className="absolute bottom-0 left-0 right-0 p-6 bg-theme-surface border-t border-theme-primary-200 rounded-b-lg">
